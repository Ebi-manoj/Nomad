...
// Zod schema without forcing helmet value
...
export const Ride = () => {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 scale-90">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm">
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <p className="text-xs text-gray-500 text-center mt-3">
              *Your ride will be visible to hikers once published. Make sure
              details are correct.
            </p>
          </form>
        </div>
